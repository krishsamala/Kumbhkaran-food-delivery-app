      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex md:items-center items-center md:space-x-4">
            <button
              onClick={() => onNavigate("Home")}
              className={`flex items-center gap-2 ${getLinkClasses("Home")}`}
            >
              <lord-icon
                target="button"
            ...
            <button
              ...
              className={`flex items-center gap-2 ${getLinkClasses("Search")}`}
            >
              <lord-icon
                target="button"
            ...
            <button
              ...
              className={`flex items-center gap-2 ${getLinkClasses("Account")}`}
            >
              <lord-icon
                target="button"
            ...
            <button
              ...
              className={`flex items-center gap-2 ${getLinkClasses(
                "Cart"
              )} relative`}
            >
              <lord-icon
