    ...
    <div className="space-y-6 ">
      ...
      <header className="flex justify-center items-center pt-2 pb-2">
        <div className="flex items-center">
          ...
          <img src={logo} alt="Kumbhkaran Logo" className="h-60 w-auto z-10" />
        ...
        <div className="flex col items-center gap-6 m-7 justify-center">
          <div className="bg-gradient-to-r from-red-500 to-orange-400 text-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-sm">
              ...
              <span className="font-bold">KUMBH50</span>
            </p>
          </div>
          <div className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-sm">
              on your order above ₹999. Use code:{" "}
              <span className="font-bold">CART999</span>
            </p>
          </div>
          <div className="bg-gradient-to-r from-[rgb(234,88,12)] to-yellow-400 text-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-sm">
              on your order above ₹499. Use code:{" "}
              <span className="font-bold">FD499</span>
            </p>
          </div>
          <div
            className="text-black p-6 border-4 border-red-400 rounded-lg shadow-lg cursor-pointer"
            onClick={handleAboutusClick}
          >
            <h2 className="font-bold text-xl text-center">Made by </h2>
            <p className="text-sm">
              KRISH(60003240300) | SWAYAM(60003240300) | BHAVYA(60003240300) |
              MEET(60003240300){" "}
            </p>
          </div>
        </div>
      ...
      {/* Categories */}
      <div>
        <h3 className="justify-center bg-white/30 backdrop-blur-md shadow-md rounded-lg text-center text-2xl font-medium max-w-64 mb-1 p-1 mx-auto">
          Categories
        </h3>
        <div className="grid grid-cols-5 sm:grid-cols-5 gap-1 m-5">
          {mockCategories3d.slice(0, 6).map((category) => (
            <div
              key={category.name}
              onClick={() => openCategoryOverlay(category)}
            ...
            >
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src =
                    "https://placehold.co/100x100/cccccc/ffffff?text=Image+Error";
                }}
              />
          ...
          <div
            ...
            className="flex flex-col items-center cursor-pointer transition-transform duration-300 hover:scale-110 p-16 -mt-4 -mb-2"
          >
            <lord-icon
            ...
            ></lord-icon>
            <span className="mt-6 text-xl font-small"> View more</span>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 m-5 ">
          {mockRestaurants.map((res) => (
            <RestaurantCard
              key={res.id}
              restaurant={res}
              onClick={() => openRestaurantOverlay(res)}
            />
          ))}
        </div>
      </div>
      ...
      {/* Popular Dishes*/}
      <div>
        <h3 className="bg-orange-200 rounded-lg text-center text-xl font-bold max-w-64 mb-1 p-2 ">
          Popular Near You
        </h3>
