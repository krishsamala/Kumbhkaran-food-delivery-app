      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div
          className={`transition-all duration-500 ease-in-out overflow-hidden ${
            isAddressesExpanded ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'
          }`}
        >
          <div className="p-4 pt-0"> {/* Padding wrapper for content */}
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div
          className={`transition-all duration-500 ease-in-out overflow-hidden ${
            ...
            isFavoritesExpanded ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'
          }`}
        >
          <div className="p-4 pt-0"> {/* Padding wrapper for content */}
            {isLoadingFavorites ? (
